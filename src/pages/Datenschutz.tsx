      ...
      <div className="legal-container">
        ...
        <section>
          ...
          <p>
            ...
            Besucherstandorte sowie technische Daten (Browser- und Betriebssystemversionen) analysiert werden. 
          ...
          <p>
            Die Datenerfassung erfolgt laut IONOS vollständig anonymisiert, sodass sie nicht zu einzelnen 
        ...
        <section>
          ...
          <p>
            Wir nutzen die Google Search Console, ein kostenloses Tool der Google Ireland Limited („Google"), 
            Gordon House, Barrow Street, Dublin 4, Irland, zur Überwachung und Analyse der technischen 
            Performance unserer Website in den Google-Suchergebnissen. Dabei erhalten wir insbesondere 
            Informationen über Suchanfragen, Indexierungsprobleme und die Sichtbarkeit unserer Website.
          </p>
          <p>
            Im Rahmen der Google Search Console werden keine personenbezogenen Daten der Websitebesucher erhoben 
            oder gespeichert. Die Nutzung erfolgt auf Grundlage unseres berechtigten Interesses an der 
            Optimierung unserer Website im Sinne von Art. 6 Abs. 1 lit. f DSGVO.
          </p>
          ...
          <p>
            Google Analytics ermöglicht es uns, das Verhalten der Besucher unserer Website zu analysieren. Dabei 
            erhalten wir u. a. Informationen über Seitenaufrufe, Verweildauer, Herkunft der Nutzer und 
            verwendete Endgeräte. Google verarbeitet diese Daten in unserem Auftrag, um Reports über die 
            Websiteaktivitäten zu erstellen.
          </p>
          <p>
            Wir nutzen Google Analytics mit aktivierter IP-Anonymisierung. Das bedeutet, dass die IP-Adresse der 
            Nutzer von Google innerhalb der EU oder des EWR gekürzt wird, bevor sie gespeichert oder 
            weiterverarbeitet wird. Nur in Ausnahmefällen wird die vollständige IP-Adresse an Server von Google 
            in den USA übertragen und dort gekürzt.
          </p>
          <p>
            Die Nutzung erfolgt auf Grundlage Ihrer Einwilligung gem. Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 
            TDDDG. Sie können Ihre Einwilligung jederzeit über unser Cookie-Consent-Tool widerrufen.
          </p>
          <p>
            Weitere Informationen zur Datenverarbeitung durch Google Analytics finden Sie in der 
        ...
        <section>
          <p style={{fontSize: '0.9rem', marginTop: '3rem', opacity: 0.7}}>
